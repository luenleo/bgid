...
public class MadgwickAHRS{
    ...
    public static final float sampleFreqDef = 200.0f;
    // 2 * proportional gain
    public static final float betaDef = 0.01f;
    ...
    private void computeAngles(){
        roll = (float) atan2(q0*q1 + q2*q3, 0.5f - q1*q1 - q2*q2);
        pitch = (float) asin(-2.0f * (q1*q3 - q0*q2));
        yaw = (float) atan2(q1*q2 + q0*q3, 0.5f - q2*q2 - q3*q3);
    ...
    public void begin(float sampleFrequency) {
    ...
    public void updateIMU(float gx, float gy, float gz, float ax, float ay, float az){
        ...
        //float temp = 1.0/sqrtf(q0 * q0 + q1 * q1 + q2 * q2 + q3 * q3);
